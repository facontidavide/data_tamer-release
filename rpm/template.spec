...
Name:           ros-humble-data-tamer
Version:        0.6.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS data_tamer package

License:        MIT
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-data-tamer-msgs
Requires:       ros-humble-mcap-vendor
Requires:       ros-humble-rclcpp
Requires:       ros-humble-ros-workspace
BuildRequires:  ros-humble-ament-cmake
BuildRequires:  ros-humble-data-tamer-msgs
...
%changelog
* Thu Nov 23 2023 Davide Faconti <davide.faconti@gmail.com> - 0.6.1-1
